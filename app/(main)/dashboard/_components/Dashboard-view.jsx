...
const DashboardView = ({ insights }) => {
  ...
  return (
    <div className="space-y-8">
      ...
      <Card className="hover:shadow-md transition-shadow">
        <CardHeader>
          <CardTitle className="text-lg">Salary Ranges by Role (LPA)</CardTitle>
          <CardDescription>
            Showing minimum, median, and maximum salaries in LPA
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-[400px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={salaryData}>
                    ...
                    if (active && payload?.length) {
                      return (
                        <div className="bg-background border rounded-lg p-3 shadow-lg text-sm">
                          ...
                          {payload.map((item) => (
                            <p key={item.name}>
                              {item.name}: <span className="font-semibold">{item.value} LPA</span>
                            </p>
                          ))}
                        </div>
                      );
                ...
                />
                <Bar dataKey="min" fill="#00C9A7" name="Min Salary (LPA)" />
                <Bar dataKey="median" fill="#FFC857" name="Median Salary (LPA)" />
                <Bar dataKey="max" fill="#3A86FF" name="Max Salary (LPA)" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="hover:shadow-md transition-shadow">
          <CardHeader>
            ...
            <CardDescription>Shaping the current market</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="hover:shadow-md transition-shadow">
          <CardHeader>
            ...
            <CardDescription>Consider developing these</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-wrap gap-2">
              {insights.recommendedSkills.map((skill) => (
